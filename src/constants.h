...
#define MAX_EVALS_PER_CONTROLLER 7
#define MAX_EVALS_PER_CONTROLLER_REEVAL 20

#define N_EVALS_PER_CONTROLLER_SELECT_BEST_IN_REINITIALIZATION 30
#define REINITIALIZE_CONTROLLERS_EVERY_N_ITERATIONS 5
