...
for PROBLEM_TYPE in "qap" "tsp" "lop" "pfsp"; do
    ...
    ID=`sbatch --export=PROBLEM_TYPE=$PROBLEM_TYPE,INSTANCES=$INSTANCES,MAX_TIME_PSO=0.25,N_EVALS=30,DESTINATION_FOLDER=src/experiments/permus/results/4by4_permu_problems/all_controllers --array=0-$NUM_INSTANCES src/experiments/permus/scripts/hip_train_array.sl`
