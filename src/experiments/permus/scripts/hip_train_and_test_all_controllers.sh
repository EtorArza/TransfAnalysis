...
srun --dependency=afterok:${JOB_IDS_PROBLEMS[0]}:${JOB_IDS_PROBLEMS[1]}:${JOB_IDS_PROBLEMS[2]}:${JOB_IDS_PROBLEMS[3]}:$ID_2 src/experiments/permus/scripts/hip_test_all_controllers.sh
