...
#SBATCH --time=30-0:00:00 #Walltime
#SBATCH -p xlarge
...
list_to_array $MAX_NEAT_TIME_ARRAY
MAX_NEAT_TIME_ARRAY=("${BITRISE_CLI_LAST_PARSED_LIST[@]}")
MAX_NEAT_TIME=${MAX_NEAT_TIME_ARRAY[$SLURM_ARRAY_TASK_ID]}
