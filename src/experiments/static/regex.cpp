...
static vector<Test> create_tests_1bit(const char *grammar, const vector<string> &sentences);
static vector<Test> create_tests_2bit(const char *grammar, const vector<string> &sentences);
